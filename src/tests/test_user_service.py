...
@pytest.mark.asyncio
async def test_user_success(user_service_mocks, user):
    service, user_repo = user_service_mocks
...
@pytest.mark.asyncio
async def test_get_user_not_found(user_service_mocks, user):
    service, user_repo = user_service_mocks
...
@pytest.mark.asyncio
async def test_get_users_success(user_service_mocks, users):
    service, user_repo = user_service_mocks
...
@pytest.mark.asyncio
async def test_create_user_success(user_service_mocks, user):
    service, user_repo = user_service_mocks
...
@pytest.mark.asyncio
async def test_update_user_success(user_service_mocks, user, user_update):
    service, user_repo = user_service_mocks
...
@pytest.mark.asyncio
async def test_delete_user_success(user_service_mocks, user):
    service, user_repo = user_service_mocks
